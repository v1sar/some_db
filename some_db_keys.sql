...
CREATE TABLE `follows` (
  ...
  KEY `follower` (`follower`,`followee`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1000086 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10145 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `name` (`name`,`email`)
) ENGINE=InnoDB AUTO_INCREMENT=100057 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-28  1:39:56
